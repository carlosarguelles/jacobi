...
Después de desarrollar la actividad planteada, comparé ambos resultados y concuerdan. Además se demuestra
que el método de Gauss-Seidel requiere de menos iteraciones para llegar al error aproximado.
